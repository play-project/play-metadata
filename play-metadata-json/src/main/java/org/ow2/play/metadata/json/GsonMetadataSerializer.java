...
public class GsonMetadataSerializer implements MetaDataSerializer {
	 ...
	 */
	@Override
	public void write(Resource resouce, List<Metadata> metadata, OutputStream os)
		...
		try {
			IOUtils.write(gson.toJson(new MetaResource(resouce, metadata),
					MetaResource.class), os);
		} catch (IOException e) {
